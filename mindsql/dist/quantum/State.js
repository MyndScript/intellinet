...
class QuantumState {
    ...
    entangleWith(other) {
        this.coherence = Math.min((this.coherence + other.coherence) / 2 + 0.1, 1.0);
        this.entanglement = Math.min((this.entanglement + other.entanglement) / 2 + 0.2, 1.0);
        this.phase = (this.phase + other.phase) % (Math.PI * 2);
    }
    // Add debug methods
    toString() {
